...
namespace PandaTechEShop.Helpers
{
    ...
    public class OnOrientationLayoutOptions : IMarkupExtension<Binding>, IMarkupExtension,
        IOnOrientationValues<LayoutOptions>
    {
        ...
        private Binding CreateBinding()
        {
            return new Binding
            {
                Source = OnOrientationHelper.GetBindingSource(this, LayoutOptions.Fill), Path = "Magnitude"
            };
        }
    }
}