...
namespace PandaTechEShop.Helpers
{
    internal class NotificationObjectsTracker
    {
        ...
        private const int _defaultInitialNotificationListSize = 2000;

        private const int _defaultAutoCleanupTriggerCount = 1000;

        private const int _defaultPeriodBetweenAutoCleanups = 5000;
