...
namespace PandaTechEShop.Behaviours
{
    public class TextMatchValidatorBehavior : Behavior<Entry>
    {
        ...
        public static readonly BindableProperty TextToMatchProperty = BindableProperty.Create("TextToMatch",
            typeof(string), typeof(TextMatchValidatorBehavior), string.Empty, BindingMode.OneWay, null,
        ...
        private static readonly BindablePropertyKey _isValidPropertyKey =
            BindableProperty.CreateReadOnly("IsValid", typeof(bool), typeof(TextMatchValidatorBehavior), true);
        ...
        protected override void OnAttachedTo(Entry bindable)
        {
            if (_entry != null)
            {
                throw new InvalidOperationException(
                    $"Usage of the behavior {GetType().Name} associated to a style are not supported.");
            }
