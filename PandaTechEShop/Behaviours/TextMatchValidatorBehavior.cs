...
namespace PandaTechEShop.Behaviours
{
	public class TextMatchValidatorBehavior : Behavior<Entry>
	{
		...
		private static readonly BindablePropertyKey _isValidPropertyKey = BindableProperty.CreateReadOnly("IsValid", typeof(bool), typeof(TextMatchValidatorBehavior), true);
